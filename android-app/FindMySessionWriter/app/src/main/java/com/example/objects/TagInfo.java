...
import com.example.project.TagFeature;
...
public class TagInfo {
	...
	private ArrayList<com.example.project.TagRecord> tagUIRecords = new ArrayList<com.example.project.TagRecord>();
	...
	public ArrayList<com.example.project.TagRecord> getTagUIRecords() {
		return tagUIRecords;
	}

	public void setTagUIRecords(Context context) {
		
		com.example.project.TagRecord tagRecord = new com.example.project.TagRecord(context);
		for (int i = 0; i < tagRecords.size(); i++) {
			...
			tagRecord = new com.example.project.TagRecord(context);
		}
	}
