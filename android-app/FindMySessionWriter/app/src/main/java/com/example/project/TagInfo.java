...
public class TagInfo extends RelativeLayout {
	...
	public TagInfo(Context context) {
		...
		recordIcon.put(context.getResources().getString(R.string.tel), R.drawable.default64);
		recordIcon.put(context.getResources().getString(R.string.sms), R.drawable.geo64);
		recordIcon.put(context.getResources().getString(R.string.geoLoc), R.drawable.sms64);
		recordIcon.put(context.getResources().getString(R.string.plainText), R.drawable.tel64);
